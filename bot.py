...
async def start(bot, cmd):
	...
	if usr_cmd == "/start":
			...
			reply_markup=InlineKeyboardMarkup(
				[
					[
						...
						InlineKeyboardButton("Bots Channel", url="https://t.me/Animemusicarchive6")
					],
					[
				...
				await bot.send_message(
					...
					reply_markup=InlineKeyboardMarkup(
						[
							...
							[
								InlineKeyboardButton("🔄 Refresh / Try Again", url=f"https://telegram.dog/{BOT_USERNAME}?start=Amalbiju154_{file_id}")
							]
						]
					),
					parse_mode="markdown"
		...
		try:
			...
			await send_stored_file.reply_text(f"**Here is Sharable Link of this file:** https://telegram.dog/{BOT_USERNAME}?start=Amalbiju154_{file_id}\n\n__To Retrive the Stored File, just open the link!__", disable_web_page_preview=True, quote=True)
...
async def main(bot, message):
	if message.chat.type == "private":
		...
		try:
			...
			share_link = f"https://telegram.dog/{BOT_USERNAME}?start=Amalbiju154_{file_er_id}"
			await editable.edit(
				f"**Your File Stored in my Database!**\n\nHere is the Permanent Link of your file: {share_link} \n\nJust Click the link to get your file!",
				parse_mode="Markdown",
				reply_markup=InlineKeyboardMarkup(
					[[InlineKeyboardButton("Open Link", url=share_link)], [InlineKeyboardButton("Bots Channel", url="https://t.me/Animemusicarchive6"), InlineKeyboardButton("Support Group", url="https://t.me/Yeageristbots")]]
				),
				disable_web_page_preview=True
			)
		except Exception as err:
	...
	if "aboutbot" in cb_data:
		await cmd.message.edit(
			...
			reply_markup=InlineKeyboardMarkup(
				[
					[
						InlineKeyboardButton("Website", url="https://kvcentertainmentso.wixsite.com/yeageristbots")
					],
					[
